...
/**
 * La classe DataFrame represente le tableau a deux dimensions, où chaque colonne est une instance de la classe Series.
...
public class DataFrame {
     ...
     * Le parametre "colonne" est un Map<String, Series<?>>,
     * Où 
     *  - chaque cle est le nom de la colonne (par exemple "Age" ou "Name")
     *  - la valeur est une instance de la classe Series qui contient les donnees de cette colonne.
     *
     * @param colonne
     */
